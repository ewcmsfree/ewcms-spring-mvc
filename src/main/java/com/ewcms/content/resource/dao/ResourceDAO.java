 ...
 */
@Repository
public class ResourceDAO extends JpaDAO<Integer, Resource> implements
		ResourceDAOable {
	...
	public List<Resource> findPublishResources(final Integer siteId,
			final Boolean forceAgain) {
